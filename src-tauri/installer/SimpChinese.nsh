...
LangString installingWebview2 ${LANG_SIMPCHINESE} "正在安装必需的 Microsoft WebView2 运行时。普通包需要联网下载，完整离线包使用内置安装器。"
...
LangString webview2AbortError ${LANG_SIMPCHINESE} "Pisper 缺少必需的 Microsoft WebView2，安装成功前无法启动。如果无法连接微软服务器，请在可联网电脑从 https://github.com/ling-kong-ran/pisper/releases/latest 下载完整离线包（*-offline-setup.exe）后拷贝到本机安装。离线包也失败时，请检查 Windows 兼容性及安装权限。具体错误码见上方安装详情。"
...
LangString webview2Downloading ${LANG_SIMPCHINESE} "缺少 Microsoft WebView2，正在下载依赖安装器（不是语音模型）..."
