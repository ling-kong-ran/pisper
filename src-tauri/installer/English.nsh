; Tauri NSIS language contract, adapted for Pisper dependency guidance.
; Source: https://github.com/tauri-apps/tauri/tree/dev/crates/tauri-bundler/src/bundle/windows/nsis/languages
...
LangString installingWebview2 ${LANG_ENGLISH} "Installing required Microsoft WebView2 Runtime. The standard package needs internet access; the offline package uses its bundled installer."
...
LangString webview2AbortError ${LANG_ENGLISH} "Pisper requires Microsoft WebView2 and cannot start until it is installed. If this PC cannot reach Microsoft servers, download the full offline Pisper package (*-offline-setup.exe) from https://github.com/ling-kong-ran/pisper/releases/latest on another PC and transfer it here. If the offline installer also fails, check Windows compatibility and installation permissions. See the details above for the error code."
...
LangString webview2Downloading ${LANG_ENGLISH} "Microsoft WebView2 is missing. Downloading its installer (not a speech model)..."
