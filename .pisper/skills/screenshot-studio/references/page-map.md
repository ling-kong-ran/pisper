...
- `docs/index.html`: hero `shots/welcome-dark.png`, product tabs including `shots/chat-grid.png` / `shots/terminal.png` / `shots/workflow-builder.png` / `shots/memory.png` / `shots/channels.png` (width/height 2558x1380), tour `shots/cli.png`.
- `docs/show.html`: 17-scene tour reusing the shots above (excluding `config-desktop-pet`).
