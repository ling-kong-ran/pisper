...
const APP_EXCLUSIVE_PREFIXES = [
  ...
  'scripts/test-ios-dns-sd.sh',
  'scripts/stage-android-speech-model.mjs',
  'scripts/stage-speech-resources.mjs',
  'scripts/stage-ios-speech-resources.mjs',
  'scripts/test-ios-speech.mjs',
  'scripts/verify-ios-speech-bundle.mjs',
  'scripts/stage-android-speech-runtime.mjs',
