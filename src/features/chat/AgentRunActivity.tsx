...
import {
  ...
  toolCompletedLabel,
  type Translate,
} from './run-activity-presentation'
import {
  activityRenderKey,
...
function AgentRunActivity({
  ...
  return (
    ...
    >
      ...
      {team &&
        (teamTasks.length > 0 || teamCommunications.length > 0 || Boolean(team.summary?.text)) && (
          <details
            ...
            {teamTotal > 0 && (
              ...
              >
                <div
                  ...
                  style={{
                    width: `${Math.min(100, Math.round((teamCompleted / teamTotal) * 100))}%`,
                  }}
                />
              </div>
            )}
