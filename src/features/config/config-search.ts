...
const SECTION_TITLE_KEYS: Record<string, string> = {
  ...
  shortcuts: 'config:configPage.shortcuts',
...
const ENTRIES: readonly ConfigSearchEntry[] = [
  ...
  },
  {
    ...
    section: 'shortcuts',
    card: CONFIG_SECTION_ANCHOR,
    titleKey: 'config:configPage.shortcuts',
    keywords: [
      'keyboard',
      'shortcut',
      'hotkey',
  ...
  // —— interface 分区卡片 ——
  {
    id: 'interface-chat-layout',
    section: 'interface',
    card: 'interface-chat-layout',
    titleKey: 'config:interfaceSettings.chatLayoutTab',
    keywords: [
      'chat layout',
      'canvas',
      'diy',
  ...
  {
    id: 'interface-custom-ui',
    section: 'interface',
    card: 'interface-custom-ui',
    titleKey: 'config:interfaceSettings.customUiTab',
    keywords: [
      'custom ui',
      'standalone widgets',
      'component',
...
const ALIAS_TABLE: Record<string, readonly string[]> = {
  ...
  layout: ['interface-chat-layout'],
  布局: ['interface-chat-layout'],
  canvas: ['interface-chat-layout'],
  画布: ['interface-chat-layout'],
  diy: ['interface-chat-layout'],
  components: ['interface-custom-ui'],
  widgets: ['interface-custom-ui'],
  组件: ['interface-chat-layout', 'interface-custom-ui'],
